      ...
      <div className="rounded-lg border bg-white p-6 flex flex-col gap-5 mb-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border px-4 py-2.5 text-sm outline-none focus:border-gray-400 mt-1.5"
            placeholder="3.50"
          />
          <p className="text-xs text-gray-400 mt-1">Bankanızın uyguladığı aylık faiz oranı</p>
        </div>
